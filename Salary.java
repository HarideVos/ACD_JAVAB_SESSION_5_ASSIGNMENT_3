...
class PermanentEmp extends Employee{
	...
	void print_leave_details() {
		...
		System.out.println("Total: " + daysOff + "\n");
	}
	...
	void calculate_balance_leaves() {
		...
		this.daysOff = this.casual_leave + this.sick_leave + this.paid_leave;
		print_leave_details();
	}
...
class TemporaryEmp extends Employee{
	...
	public TemporaryEmp(int empId, String name, int daysOff, double total_salary) {
		this.empId = empId;
		this.empName = name;
	...
	void calculate_balance_leaves() {
		// TODO Auto-generated method stub
		System.out.println("Employee name: " + this.empName 
				+ "\nTotal leaves: " + this.daysOff + "\n");
	}

	@Override
	boolean avail_leave(int no_of_leaves, char type_of_leave) {
		// TODO Auto-generated method stub
		if (no_of_leaves <= this.daysOff) {
			this.daysOff -= no_of_leaves;
			calculate_balance_leaves();
			return true;
		}
		return false;
...
public class Salary {
	public static void main(String[] args) {
		PermanentEmp pe = new PermanentEmp(1, "Emily Johnston", 3,8,15, 12000);
		TemporaryEmp te = new TemporaryEmp(2, "Layla Johnston", 13, 30000);
